...
We can copy the code that the ggplot GUI app uses to produce this histogram as a shortcut. Because the app is limited in features, we will work on customizing the histogram more next.
```{r Code from GUI}
